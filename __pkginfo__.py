...
project_urls = {
		"Documentation": f"https://custom_wx_icons_hicolor.readthedocs.io",  # TODO: Make this link match the package version
...
make_importable.make_importable(import_name, 'Hicolor')
