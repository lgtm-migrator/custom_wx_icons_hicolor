...
The ``wx_icons_hicolor`` source code is available on GitHub,
...
The recommended way to build ``wx_icons_hicolor`` is to use `tox <https://tox.readthedocs.io/en/latest/>`_:
