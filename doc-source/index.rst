...
.. tabs::
	...
	.. tab:: from GitHub
		...
		.. prompt:: bash
			...
			pip install git+https://github.com/domdfcoding/custom_wx_icons_hicolor@master
...
`Browse the GitHub Repository <https://github.com/domdfcoding/custom_wx_icons_hicolor>`__
